...
const Home = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center">
      ...
      <div className="container mt-20 mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl text-white">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Empowering Students for a Better Tomorrow
          </h1>
          <p className="text-lg md:text-xl mb-8">
            At Bright Minds Academy, we help students reach their full potential
            through expert guidance, personalized attention, and innovative
            teaching methods.
          </p>
          <button
            onClick={() => scrollToSection("courses")}
            className="cursor-pointer bg-blue-600 text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-blue-700 transition-colors duration-300"
          >
            Explore Courses
          </button>

          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-opacity-10 backdrop-blur-sm p-6 rounded-lg flex items-start transition-transform duration-300 hover:scale-105">
